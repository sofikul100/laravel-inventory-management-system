  ...
  <div class="content-wrapper">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <h3 class="pt-2 pl-2 text-right mr-1">Customer Credit List </h3>
                    ...
                    @foreach($payment as $key => $data)                          
                         ...
                         <td>
                           <a href="{{ route('credit.customer.eidt',$data->id) }}" title="Edit" class="btn btn-info btn-sm"><i class="fas fa-edit"></i></a>
                           <a href="{{ route('customer.due.list',$data->invoice_id) }}" target="_blank" title="Deteils" class="btn btn-primary btn-sm" ><i class="fas fa-eye"></i></a>
                         </td>
                           </tr>
                           @php
